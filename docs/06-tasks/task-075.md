# task-075: Get Periodontal Assessment
...
Retrieve a full periodontal assessment with all its measurements for display in the chart UI.
...
- **SAD:** docs/03-sad/15-module-emr.md Part 3.2A-3.2D (Periodontal Assessment & Clinical Examination, lines 3547-6118); endpoint: GET /api/v1/emr/periodontal-assessments/{assessmentId}
...
- GetPeriodontalAssessmentUseCase.
- GET /api/v1/emr/periodontal-assessments/{assessmentId} controller + DTOs.
...
- Adds GET /api/v1/emr/periodontal-assessments/{assessmentId}.
...
- Returns the assessment with all measurements.
...
- **Can Run In Parallel With:** task-076, task-077.
