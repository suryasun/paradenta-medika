# task-074: Delete Periodontal Measurement
...
Remove an erroneously entered measurement before the assessment is locked.
...
- **SAD:** docs/03-sad/15-module-emr.md Part 3.2A-3.2D (Periodontal Assessment & Clinical Examination, lines 3547-6118); endpoint: DELETE /api/v1/emr/periodontal-assessments/{assessmentId}/measurements/{id}
...
- DeletePeriodontalMeasurementUseCase; same lock restriction as task-073.
- DELETE /api/v1/emr/periodontal-assessments/{assessmentId}/measurements/{id} controller + DTOs.
...
- Adds DELETE /api/v1/emr/periodontal-assessments/{assessmentId}/measurements/{id}.
...
- Delete succeeds on an unlocked assessment; rejected on a locked one.
...
- **Can Run In Parallel With:** task-073.
