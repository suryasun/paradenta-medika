# task-117: Submit Transfer (POST /transfers/{transferId}/submit)
...
Transition a draft transfer to `submitted` for approval.
...
- Presentation layer: route, controller, DTO/validator for `POST /warehouse/transfers/{transferId}/submit`.
- Application layer: `SubmitStockTransferUseCase`.
...
Adds POST /warehouse/transfers/{transferId}/submit per docs/03-sad/18-module-warehouse.md Section 6.3.
...
- `SubmitStockTransferUseCase`, route, controller, tests
