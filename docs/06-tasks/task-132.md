# task-132: Approve Stock Opname (POST /stock-opnames/{opnameId}/approve)
...
Approve the counted variance, enforcing maker-checker (approver ≠ requester).
...
- Presentation layer: route, controller, DTO/validator for `POST /warehouse/stock-opnames/{opnameId}/approve`.
- Application layer: `ApproveStockOpnameUseCase`.
...
Adds POST /warehouse/stock-opnames/{opnameId}/approve per docs/03-sad/18-module-warehouse.md Section 6.4.
...
- `ApproveStockOpnameUseCase`, route, controller, tests
