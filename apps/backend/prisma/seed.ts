...
export const PERMISSION_KEYS = [
  ...
  'emr.treatment.update',
  'emr.treatment.delete',
  ...
  'masterdata.insurance-provider.manage',
  'masterdata.insurance-provider.read',
...
export const MENU_TREE: MenuSeedNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'master-data.insurance-providers', label: 'Insurance Providers', route: '/master-data/insurance-providers', permissionKey: 'masterdata.insurance-provider.read' },
